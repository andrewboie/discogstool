...
class MP4Tags(DictProxy, Metadata):
    ...
    def __parse_blob(self, atom, data):
        self[atom.name] = data

    def __render_blob(self, key, value):
        return Atom.render(key, value)
    ...
    __atoms = {
        ...
        "NITR": (__parse_blob, __render_blob),
    ...
    def pprint(self):
        ...
        for key, value in self.iteritems():
            ...
            if key == "covr":
                ...
                values.append("%s=%s" % (key, hashlib.sha1(value).hexdigest()))
